...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    // regionsPopupBtn.addEventListener('click', function () {
    //     const contentCities = document.querySelectorAll('[name="city"]');
    //     const contentRegions = document.querySelectorAll('[name="district"]');
    //     fetch('fetch/data/cities.php', {
    //         method: 'POST',
    //     }).then(async (response) => {
    //         let responseResult = await response.json();
    //         let resultDataCities = '';
    //         let resultDataRegions = '';
    //         const currentRegions = responseResult[0].REGIONS;
    //         console.log(currentRegions);
    //         responseResult.forEach((elem) => {
    //             const option = `<option value="${elem.CITY}">${elem.CITY}</option>`;
    //             resultDataCities += option;
    //         });

    //         currentRegions.forEach((elem) => {
    //             const optionRegion = `<option value="${elem}">${elem}</option>`;
    //             resultDataRegions += optionRegion;
    //         });
    ...
    //         contentRegions.forEach((elem) => {
    //             elem.innerHTML = resultDataRegions;
    //         });
    //     });
    // });

    // const citiesSelect = document.querySelectorAll("[name='city']");
    // citiesSelect.forEach((elem) => {
    ...
    //             let resultDataRegions = '';
    //             const activeValue = elem.options[elem.selectedIndex].value;

    //             let currentRegions;
    //             responseResult.forEach((city) => {
    //                 if (city.CITY == activeValue) {
    //                     currentRegions = city.REGIONS;
    //                 }
    //             });
    ...
    const promotionsResponce = await fetch('fetch/data/promotions.php');
    ...
    const servicesResponce = await fetch('fetch/data/services.php');
    ...
    const reviewsResponce = await fetch('fetch/data/reviews.php');
